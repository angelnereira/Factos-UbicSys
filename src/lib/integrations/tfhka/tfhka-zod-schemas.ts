...
const ClienteSchema = z.object({
  ...
  correoElectronico1: z.string().email().optional(),
...
const DatosTransaccionSchema = z.object({
  ...
  puntoFacturacionFiscal: z.string().optional(),
  ...
  envioContenedor: z.string().optional(),
...
const DocumentoSchema = z.object({
  ...
  tipoSucursal: z.string().optional(),
